...
{
  "id": "statistical-thinking-activity-2-1",
  "level": "2",
  "url": "statistical-thinking-activity.html#statistical-thinking-activity-2-1",
  "type": "Worksheet Exercise",
  "number": "1",
  "title": "",
  "body": "  Objectives: This activity highlights the statistical thinking mindset, where we observe several ways to quantitatively summarize data and then draw justified conclusions about a population.  Does this drug work?  The below table reports the number of people who became very sick after contracting an illness, broken out by if they took a particular drug. We will refer to those who took the drug as the treatment group, and those who did not take the drug as the control group. Note that the drug was not randomly assigned in this setting.  Table 1: Control — Sick: 253, Total: 151,054 Treatment — Sick: 402, Total: 47,008 Overall — Sick: 655, Total: 198,062   "
},
{
